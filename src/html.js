import { node, text, doc, keyedNode, customElement } from './dom.js'
...
const factory =
  ...
  /**
   * @template T
   * @param {import('./dom.js').Attribute<T>[]} [settings]
   * @param {import('./dom.js').Node<T>[]} [children]
   */
  (settings, children) =>
    node(tag, settings, children)
