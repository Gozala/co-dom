...
export declare function style(key: string, value: string): Attribute<never>

export interface Decoder<In, Out> {
  decode(input: In): Out | Error
}
...
export declare function virtualize<T>(target: EventTarget): Node<T>
